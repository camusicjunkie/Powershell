...
#>
    ...
    Begin
    {
        ...
        #This will yield only 32 bit software and double entries on 64 bit systems running 32 bit PowerShell
                            ...
                            if($thisSubKey){
                                try
                                {
                                    ...
                                    )
                                    {
                                        ...
                                        $obj = New-Object PSObject -Property $props #| select ComputerName, DisplayName, Publisher, Version, UninstallString, InstallDate
                                        Write-Output $obj
                                    }
                                }
                                Catch
